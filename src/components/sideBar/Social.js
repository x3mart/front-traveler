    ...
    <>
      <div className='social_block'>
        <div className='social_block_head'>
          ...
          <h4>
            Повысьте доверие пользователей к себе – привяжите ваши аккаунты социальных сетей к профилю Traveler Mrket. 
            Ваши контактные данные будут скрыты от пользователей.
          </h4>
        </div>
