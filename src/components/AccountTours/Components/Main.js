  ...
  return (
    <>
      ...
      >
        ...
        <SingleWrapper label='Основной тип тура. Отображается в карточке тура в каталоге.' comment='' tour={tour} name={'basic_type'}>
          <SelectInput
            action={handleInput}
            name='basic_type'
        ...
        <SingleWrapper
          ...
          comment='Дополнительные туры учитываются при поиске тура по типам. Можно добавить несколько типов тура.'
        ...
        <CheckboxInput
          ...
          comment='“Тур гарантирован“ означает, что он точно состоится. Отмена гарантированного тура после получения предоплаты влечет начисление штрафа (см. раздел VI. Изменение бронирования, отмена и возврат)'
        ...
        <SingleWrapper
          ...
          comment={<div>
            ...
            <p>
              Пожалуйста, добавляйте актуальную информацию о том,
              кто будет сопровождать группу.
            </p>
            <p>
              Гида выбрать из выпадающего списка.
            </p>
          </div>}
