...
const AvatarInput = ({ action, name, value, max, tour, deleteTourWallpaper, delete_avatar, required, type, deleteTeamMemberAvatar, member, error = {}, activity_id=null, deleteActivityImage }) => {
    ...
    <>
      ...
      {!deleted && <div className='fake-file-input-component' id={name}>
        ...
        <div className='fake-file-input-wrapper'>
          {!preview && <div
            className={`fake-file-input avatar file-input ${
          ...
          {preview && (
            ...
            // />
            <div
              className='fake-file-input avatar image-container'
              style={{
                backgroundImage: 'url(' + preview + ')',
                position: 'relative',
              }}
...
export default connect(mapStateToProps, { deleteTourWallpaper, delete_avatar, deleteTeamMemberAvatar, deleteActivityImage })(AvatarInput)
