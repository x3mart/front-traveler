...
import LikeIcon from '../../assets/img/heartblack.svg';
import ClockIcon from '../../assets/img/clock.svg';
import PeopleIcon from '../../assets/img/people.svg';  
import CalendarIcon from '../../assets/img/calendarsmall.svg';
import ArrowGreyIcon from '../../assets/img/arrowdowngrey.svg';
import MinusIcon from '../../assets/img/minus.svg';
import PlusIcon from '../../assets/img/plus.svg';
import StarIcon from '../../assets/img/Star.svg';
    
const CardOnTop = ({ block_style, block_width, children, className, ...props }) => {    
    return (
        <div
