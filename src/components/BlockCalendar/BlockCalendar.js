...
const BlockCalendar = ({ children, className, ...props }) => {
  return (
    <div className={cn(styles.calendar, className, {})}>
      ...
      <div className={styles.calendar_block} {...props}>
        <div className={styles.calendar_block_month} {...props}>
          <div className={styles.calendar_block_month_button} {...props}>
            <ArrowIconLeft />
          </div>
          <div className={styles.calendar_block_month_text} {...props}>
            Январь, 2021
          </div>
          <div className={styles.calendar_block_month_button} {...props}>
            <ArrowIconRight />
        ...
        <div className={styles.calendar_block_week} {...props}>
          <div className={styles.calendar_block_week_day} {...props}>
            пн
          </div>
          <div className={styles.calendar_block_week_day} {...props}>
            вт
        ...
        <div className={styles.calendar_block_days} {...props}>
          <div className={styles.calendar_block_day} {...props}>
            29
          </div>
          <div className={styles.calendar_block_day} {...props}>
            30
        ...
        <div className={styles.calendar_block_submit} {...props}>
          Применить
        </div>
        <div className={styles.calendar_block_cancel} {...props}>
          Сбросить выбор
        </div>
      </div>
    </div>
