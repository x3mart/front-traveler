  ...
  return (
    ...
    >
      <div className={styles.wrapper} {...props}>
        {children}
        <Htag tag='h2'>Главные впечатления</Htag>
        <div className={styles.impression_block} {...props}>
          <div className={styles.impression_block_item} {...props}>
            <DoneIcon />
            Бархан Сарыкум
          </div>
          <div className={styles.impression_block_item} {...props}>
...
export default BlockImpression
